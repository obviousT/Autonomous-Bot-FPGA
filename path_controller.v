...
us_sensor us_l(clk, reset , echo_rx_l, trig_l, ob_us_l, dis_l);
us_sensor us_r(clk, reset , echo_rx_r, trig_r, ob_us_r, dis_r);
us_sensor us_f(clk, reset , echo_rx_f, trig_f, ob_us_f, dis_f);
